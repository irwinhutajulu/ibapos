...
<template x-teleport="body">
    <div x-data="modalComponent()"
        ...
        class="fixed inset-0 z-50 flex <?php echo e($maxHeight ? 'items-center' : 'items-start overflow-auto'); ?> justify-center p-4"
        x-cloak
        id="<?php echo e($id); ?>"
        <?php if($keyboard): ?>
    ...
    <div class="relative transform overflow-hidden rounded-xl bg-gray-800 dark:bg-gray-800 shadow-2xl border border-gray-700 dark:border-gray-600 w-full <?php echo e($sizeClass); ?>"
         @click.stop
         x-transition:enter="ease-out duration-300"
         x-transition:enter-start="opacity-0 scale-95"
         x-transition:enter-end="opacity-100 scale-100"
         ...
         x-transition:leave-end="opacity-0 scale-95">
            ...
            <div class="p-4 bg-gray-800 dark:bg-gray-800 text-white" data-modal-body
                 :class="{ 'max-h-[80vh] overflow-y-auto custom-scrollbar': <?php echo e($maxHeight ? 'true' : 'false'); ?> }">
                <?php echo e($slot); ?>
...
<?php /**PATH C:\xampp\htdocs\Data IBA POS\IBAPOS\resources\views/components/modal.blade.php ENDPATH**/ ?>