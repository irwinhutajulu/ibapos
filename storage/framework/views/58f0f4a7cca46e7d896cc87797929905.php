...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.product-form','data' => ['product' => $product,'categories' => [],'action' => '','method' => 'GET','mode' => 'show']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['product' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($product),'categories' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([]),'action' => '','method' => 'GET','mode' => 'show']); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Data IBA POS\IBAPOS\resources\views/products/partials/show-form.blade.php ENDPATH**/ ?>