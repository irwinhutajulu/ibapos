...
class="<?php echo e($positionClass); ?> z-50"
x-cloak
id="floating-success">
...
function floatingSuccessComponent() {
    return {
        ...
        init() {
            ...
            <?php if(session('ok')): ?>
                this.message = <?php echo json_encode(session('ok')); ?>;
                this.show = true;
...
<?php /**PATH C:\xampp\htdocs\Data IBA POS\IBAPOS\resources\views/components/floating-success.blade.php ENDPATH**/ ?>