...
<div class="card mb-6" x-data="{ 
    categoryId: '<?php echo e($categoryId ?? ''); ?>', 
    trashed: <?php echo e($trashed ? 'true' : 'false'); ?>,
    updateFilters() {
...
<!-- Permission Notice -->
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->denies('products.create')): ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center space-x-3">
                                    <div class="flex-shrink-0">
                                        <img :src="product.image_url || '<?php echo e(asset('images/default-product.svg')); ?>'" 
                                             :alt="product.name"
...
<?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php if(!$p->deleted_at && auth()->user()->can('products.delete')): ?>
    <form id="delete-form-<?php echo e($p->id); ?>" action="<?php echo e(route('products.destroy', $p)); ?>" method="POST" style="display: none;">
        <?php echo csrf_field(); ?>
    ...
    <?php if($p->deleted_at): ?>
    <form id="restore-form-<?php echo e($p->id); ?>" action="<?php echo e(route('products.restore', $p->id)); ?>" method="POST" style="display: none;">
        <?php echo csrf_field(); ?>
    </form>
    
    <form id="force-delete-form-<?php echo e($p->id); ?>" action="<?php echo e(route('products.force-delete', $p->id)); ?>" method="POST" style="display: none;">
        <?php echo csrf_field(); ?>
    </form>
    <?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
function deleteProduct(id, name) {
    ...
    openConfirmationModal('delete-confirmation-modal', function() {
        ...
        if (form) {
            ...
            dynamicForm.action = `<?php echo e(url('products')); ?>/${id}`;
...
function restoreProduct(id, name) {
    ...
    openConfirmationModal('restore-confirmation-modal', function() {
        ...
        if (form) {
            ...
            const dynamicForm = document.createElement('form');
            dynamicForm.method = 'POST';
            dynamicForm.action = `<?php echo e(url('products')); ?>/${id}/restore`;
            dynamicForm.style.display = 'none';
...
function forceDeleteProduct(id, name) {
    ...
    openConfirmationModal('force-delete-confirmation-modal', function() {
        ...
        if (form) {
            ...
            const dynamicForm = document.createElement('form');
            dynamicForm.method = 'POST';
            dynamicForm.action = `<?php echo e(url('products')); ?>/${id}/force-delete`;
            dynamicForm.style.display = 'none';
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['id' => 'product-modal','title' => 'Product','size' => '2xl','maxHeight' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'product-modal','title' => 'Product','size' => '2xl','max-height' => true]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.confirmation-modal','data' => ['id' => 'delete-confirmation-modal','title' => 'Delete Product','message' => 'Are you sure you want to delete this product? It can be restored later.','confirmText' => 'Delete','cancelText' => 'Cancel','confirmClass' => 'btn-danger','icon' => 'warning']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'delete-confirmation-modal','title' => 'Delete Product','message' => 'Are you sure you want to delete this product? It can be restored later.','confirm-text' => 'Delete','cancel-text' => 'Cancel','confirm-class' => 'btn-danger','icon' => 'warning']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php if (isset($component)) { $__componentOriginal5b8b2d0f151a30be878e1a760ec3900c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5b8b2d0f151a30be878e1a760ec3900c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.confirmation-modal','data' => ['id' => 'force-delete-confirmation-modal','title' => 'Permanently Delete Product','message' => 'Are you sure you want to permanently delete this product? This action cannot be undone.','confirmText' => 'Delete Forever','cancelText' => 'Cancel','confirmClass' => 'btn-danger','icon' => 'danger']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('confirmation-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'force-delete-confirmation-modal','title' => 'Permanently Delete Product','message' => 'Are you sure you want to permanently delete this product? This action cannot be undone.','confirm-text' => 'Delete Forever','cancel-text' => 'Cancel','confirm-class' => 'btn-danger','icon' => 'danger']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal5b8b2d0f151a30be878e1a760ec3900c)): ?>
<?php $attributes = $__attributesOriginal5b8b2d0f151a30be878e1a760ec3900c; ?>
...
<?php if (isset($component)) { $__componentOriginal5b8b2d0f151a30be878e1a760ec3900c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5b8b2d0f151a30be878e1a760ec3900c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.confirmation-modal','data' => ['id' => 'restore-confirmation-modal','title' => 'Restore Product','message' => 'Are you sure you want to restore this product?','confirmText' => 'Restore','cancelText' => 'Cancel','confirmClass' => 'btn-success','icon' => 'success']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('confirmation-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'restore-confirmation-modal','title' => 'Restore Product','message' => 'Are you sure you want to restore this product?','confirm-text' => 'Restore','cancel-text' => 'Cancel','confirm-class' => 'btn-success','icon' => 'success']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal5b8b2d0f151a30be878e1a760ec3900c)): ?>
<?php $attributes = $__attributesOriginal5b8b2d0f151a30be878e1a760ec3900c; ?>
...
function openCreateProductModal() {
    ...
    loadModalContent('<?php echo e(route("products.create")); ?>?modal=1');
...
function editProduct(id) {
    ...
    loadModalContent(`<?php echo e(url('products')); ?>/${id}/edit?modal=1`);
    openModal('product-modal');
}
...
function showProduct(id) {
    ...
    loadModalContent(`<?php echo e(url('products')); ?>/${id}?modal=1`);
    openModal('product-modal');
}
...
function responsiveProductSearch() {
    return {
        ...
        pagination: <?php echo json_encode($products->toArray(), 15, 512) ?>,
        loading: false,
        searchTimeout: null,
        
        init() {
            // Initialize with current data and search query from server
            this.searchQuery = '<?php echo e($search ?? ''); ?>';
        ...
        async performSearch(page = 1) {
            ...
            try {
                ...
                const response = await fetch(`<?php echo e(route('api.products.search')); ?>?${params.toString()}`, {
                    headers: {
                        'X-Requested-With': 'XMLHttpRequest',
...
<?php echo $__env->make('layouts.app', ['title' => 'Products'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Data IBA POS\IBAPOS\resources\views/products/index.blade.php ENDPATH**/ ?>