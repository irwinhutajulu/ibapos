...
<head>
    ...
    <title><?php echo e($title ?? 'IBAPOS'); ?></title>
        ...
        <div :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'"
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <div class="flex items-center space-x-2">
                            ...
                            <?php if(app()->environment('local') && config('app.developer_mode')): ?>
            ...
            <nav class="p-6 space-y-2 overflow-y-auto h-full">
                ...
                <div class="pt-4">
                    ...
                    <a href="<?php echo e(route('pos.index')); ?>" class="group flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all duration-200 text-gray-700 dark:text-gray-200">
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sales.read')): ?>
                    <a href="<?php echo e(route('sales.index')); ?>" class="group flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-gray-100/80 dark:hover:bg-gray-700/50 transition-all duration-200 text-gray-700 dark:text-gray-200">
                        <div class="w-5 h-5 text-gray-500 group-hover:text-blue-500 transition-colors">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="pt-4">
                    ...
                    <a href="<?php echo e(route('products.index')); ?>" class="group flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-gray-100/80 dark:hover:bg-gray-700/50 transition-all duration-200 text-gray-700 dark:text-gray-200">
                    ...
                    <a href="<?php echo e(route('categories.index')); ?>" class="group flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-gray-100/80 dark:hover:bg-gray-700/50 transition-all duration-200 text-gray-700 dark:text-gray-200">
                        <div class="w-5 h-5 text-gray-500 group-hover:text-green-500 transition-colors">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('stocks.read')): ?>
                    <a href="<?php echo e(route('stocks.index')); ?>" class="group flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-gray-100/80 dark:hover:bg-gray-700/50 transition-all duration-200 text-gray-700 dark:text-gray-200">
                        <div class="w-5 h-5 text-gray-500 group-hover:text-green-500 transition-colors">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="<?php echo e(route('stock-adjustments.index')); ?>" class="group flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-gray-100/80 dark:hover:bg-gray-700/50 transition-all duration-200 text-gray-700 dark:text-gray-200">
                        <div class="w-5 h-5 text-gray-500 group-hover:text-green-500 transition-colors">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('stock_mutations.request')): ?>
                    <a href="<?php echo e(route('stock-mutations.index')); ?>" class="group flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-gray-100/80 dark:hover:bg-gray-700/50 transition-all duration-200 text-gray-700 dark:text-gray-200">
                        <div class="w-5 h-5 text-gray-500 group-hover:text-green-500 transition-colors">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="pt-4">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('purchases.read')): ?>
                    <a href="<?php echo e(route('purchases.index')); ?>" class="group flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-gray-100/80 dark:hover:bg-gray-700/50 transition-all duration-200 text-gray-700 dark:text-gray-200">
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('suppliers.read')): ?>
                    <a href="<?php echo e(route('suppliers.index')); ?>" class="group flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-gray-100/80 dark:hover:bg-gray-700/50 transition-all duration-200 text-gray-700 dark:text-gray-200">
                        <div class="w-5 h-5 text-gray-500 group-hover:text-purple-500 transition-colors">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="pt-4">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('customers.read')): ?>
                    <a href="<?php echo e(route('customers.index')); ?>" class="group flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-gray-100/80 dark:hover:bg-gray-700/50 transition-all duration-200 text-gray-700 dark:text-gray-200">
                ...
                <div class="pt-6 border-t border-gray-200/50 dark:border-gray-700/50">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('stocks.read')): ?>
                    <a href="<?php echo e(route('reservations.index')); ?>" class="group flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-gray-100/80 dark:hover:bg-gray-700/50 transition-all duration-200 text-gray-700 dark:text-gray-200">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.permissions')): ?>
                    <a href="<?php echo e(route('admin.notifications.index')); ?>" class="group flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-gray-100/80 dark:hover:bg-gray-700/50 transition-all duration-200 text-gray-700 dark:text-gray-200">
        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <header class="h-20 flex items-center justify-between bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border-b border-gray-200/50 dark:border-gray-700/50 px-6 sticky top-0 z-20">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <form method="POST" action="<?php echo e(route('active-location.set')); ?>" class="flex items-center space-x-2">
                        <?php echo csrf_field(); ?>
                        ...
                        <select name="location_id" 
                            ...
                            <?php $__currentLoopData = auth()->user()->locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($loc->id); ?>" <?php if($activeId == $loc->id): echo 'selected'; endif; ?>><?php echo e($loc->name); ?></option>
                    ...
                    <?php else: ?>
                    <?php if (isset($component)) { $__componentOriginal455f38688ef82bf9b102112939e4e41e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal455f38688ef82bf9b102112939e4e41e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-user','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('dropdown-user'); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal455f38688ef82bf9b102112939e4e41e)): ?>
<?php $attributes = $__attributesOriginal455f38688ef82bf9b102112939e4e41e; ?>
<?php unset($__attributesOriginal455f38688ef82bf9b102112939e4e41e); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal455f38688ef82bf9b102112939e4e41e)): ?>
<?php $component = $__componentOriginal455f38688ef82bf9b102112939e4e41e; ?>
<?php unset($__componentOriginal455f38688ef82bf9b102112939e4e41e); ?>
<?php endif; ?>
                    <?php endif; ?>
                </div>
            </header>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.breadcrumbs','data' => ['items' => $breadcrumbs['items'] ?? [],'title' => $breadcrumbs['title'] ?? ($title ?? null)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['items' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($breadcrumbs['items'] ?? []),'title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($breadcrumbs['title'] ?? ($title ?? null))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                ...
                <?php echo $__env->yieldContent('content'); ?>
                        ...
                        <?php if(auth()->guard()->check()): ?>
                        <script>
                            window.appActiveLocationId = <?php echo e((int) session('active_location_id')); ?>;
                        </script>
                        <?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal206c4fc6124ff0d7cda302b748549710 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal206c4fc6124ff0d7cda302b748549710 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.floating-success','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('floating-success'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal206c4fc6124ff0d7cda302b748549710)): ?>
<?php $attributes = $__attributesOriginal206c4fc6124ff0d7cda302b748549710; ?>
<?php unset($__attributesOriginal206c4fc6124ff0d7cda302b748549710); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal206c4fc6124ff0d7cda302b748549710)): ?>
<?php $component = $__componentOriginal206c4fc6124ff0d7cda302b748549710; ?>
<?php unset($__componentOriginal206c4fc6124ff0d7cda302b748549710); ?>
<?php endif; ?>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\Data IBA POS\IBAPOS\resources\views/layouts/app.blade.php ENDPATH**/ ?>