...
class ProductController extends Controller
{
    ...
    private function getProductActions($p)
    {
        ...
        return collect([
            !$p->deleted_at && (auth()->check() && auth()->user()->can('products.read')) ? [
                'type' => 'button',
            ...
            !$p->deleted_at && (auth()->check() && auth()->user()->can('products.update')) ? [
                'type' => 'button',
            ...
            !$p->deleted_at && (auth()->check() && auth()->user()->can('products.delete')) ? [
                'type' => 'button',
                'label' => 'Delete',
                'style' => 'danger',
